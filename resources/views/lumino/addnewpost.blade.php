...
<div class="row">
   <div class="col-lg-12">
      <h1 class="page-header">{{ __('Add New Article') }}</h1>
   </div>
</div>
<!--/.row-->
<div class="col-md-12">
      ...
      <form action="{{ route('posts.store') }}" method="POST">
         ...
         <div class="panel-body">
            <div class="form-group ">
               ...
               <input type="text" class="form-control form-control-lg"  autocomplete="off" placeholder="{{ __('Title') }}" name="title" required>
            </div>
